...
DROP TABLE IF EXISTS `#__translations_fields`;
CREATE TABLE `#__translations_fields` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
...
(2, 11, '2013-09-13 23:09:34', 2, '', '', 0, '', '', 0, 'I love InstantCMS', 0, 0),
(3, 2, '2013-09-13 23:11:00', 2, 'комментарий', '/stati/marketing/yelastichnost-sprosa.html#c13', 13, 'Эластичность спроса', '/stati/marketing/yelastichnost-sprosa.html', 0, 'Спасибо автору за такую отличную статью!', 0, 0),
(4, 27, '2013-09-13 23:13:37', 1, '2', '', 0, 'Мои картинки', '/users/admin/photos/private5.html', 5, ' <a href="/users/1/photo6.html" class="act_photo">\r\n											<img border="0" src="/images/users/photos/small/b22c5c0f95c1fb9398578fd5e396c7dd.jpg" />\r\n									</a>  <a href="/users/1/photo7.html" class="act_photo">\r\n											<img border="0" src="/images/users/photos/small/efe8d13779cd84cfeb319d9f0875a511.jpg" />\r\n									</a> ', 0, 0),
(5, 20, '2013-09-13 23:18:39', 3, 'Администратор', '/users/admin', 11, '', '', 0, '', 0, 0),
(6, 2, '2013-09-13 23:19:19', 3, 'комментарий', '/stati/marketing/yelastichnost-sprosa.html#c14', 14, 'Эластичность спроса', '/stati/marketing/yelastichnost-sprosa.html', 0, 'Полностью согласен с Вами, коллега.', 0, 0),
(7, 15, '2013-09-13 23:21:43', 3, 'Клуб любителей InstantCMS', '/clubs/14', 14, '', '', 0, '', 0, 0);
...
(1, 1, 'Пример блога админа', '2013-09-03 13:26:55', 'all', 'list', 1, 'single', 0, 1, 'user', 'primer-bloga-admina', 0),
(24, 14, 'Блог клуба любителей InstantCMS', '2013-09-20 00:02:41', 'all', 'list', 1, 'multi', 0, 0, 'club', 'instantcms-lovers', 0);
...
(4, 10, 1, 'Предлагаю', 'свои услуги', 'Могу выносить мусор и мыть пол.', 'Москва', '2013-09-11 14:11:18', 10, 1, '550de8a5de9b5301133a815de31be00d.jpg', 7, 0, '0000-00-00 00:00:00', 2130706433),
(5, 9, 1, 'Обменяю', 'ВАЗ-2107 на Nissan Skyline GTR', 'Желательно новый и без доплаты.', 'Москва', '2013-09-12 14:14:24', 10, 1, '931f90c50adcea1ff18177bc22d4ceac.jpg', 34, 0, '0000-00-00 00:00:00', 2130706433),
(6, 8, 2, 'Сдам', '2-х комнатную квартиру', 'Семье из 2-3 человек', 'Москва', '2013-09-13 15:57:22', 10, 1, '80204e6bad519060bca9d456949158dc.jpg', 2, 0, '0000-00-00 00:00:00', 2130706433);
...
INSERT INTO `#__clubs` (`id`, `admin_id`, `title`, `description`, `imageurl`, `pubdate`, `clubtype`, `published`, `maxsize`, `enabled_blogs`, `enabled_photos`, `rating`, `members_count`, `photo_premod`, `blog_premod`, `blog_min_karma`, `photo_min_karma`, `album_min_karma`, `join_min_karma`, `join_karma_limit`, `create_karma`, `is_vip`, `join_cost`) VALUES
(14, 1, 'Клуб любителей InstantCMS', '', '', '2013-09-12 14:41:45', 'public', 1, 0, '-1', '-1', 0, 2, 0, 0, 0, 0, 25, 0, 0, 0, 0, 0);
...
(8, 0, 0, 1, 'article', 32, '', 'Питание прогиба исходным материалом, несмотря на не менее значительную разницу в плотности теплового потока, составляет биотит, так как совершенно однозначно указывает на существование', '', '2013-09-13 23:45:56', 1, 1, 'Почему нерезко плато?!!!', '/content/stati/geologija/pochemu-nerezko-plato.html', ''),
(13, 0, 0, 2, 'article', 34, '', 'Спасибо автору за такую отличную статью!', '', '2013-09-13 23:11:00', 1, 1, 'Эластичность спроса', '/stati/marketing/yelastichnost-sprosa.html', '127.0.0.1'),
(14, 13, 0, 3, 'article', 34, '', 'Полностью согласен с Вами, коллега.', '', '2013-09-13 23:19:19', 1, 1, 'Эластичность спроса', '/stati/marketing/yelastichnost-sprosa.html', '127.0.0.1');
...
INSERT INTO `#__comment_targets` (`id`, `target`, `component`, `title`, `target_table`, `subj`) VALUES
(1, 'article', 'content', 'Статьи', 'cms_content', 'вашей статьи'),
(2, 'blog', 'blogs', 'Посты блогов', 'cms_blog_posts', 'вашей записи в блоге'),
(3, 'palbum', 'photos', 'Фотоальбомы', 'cms_photo_albums', 'вашего фотоальбома'),
...
(3, 3, '2013-09-14 20:09:54', 1, 'У меня не работает чайник. Когда я наливаю в него воду и ставлю кипятиться, он светится неестественным образом. Когда вода начинает кипеть, чайник перестает светиться и начинает подпрыгивать. Один раз он упрыгал в ванну.\r\n\r\nПодскажите, как мне его починить?', '<p>Василий, ваша проблема встречается очень часто. И, к сожалению, вряд ли вам чем-то можно помочь. Единственное, что мы можем - это заявить на вас в милицию. Так что решайте, что вам дороже.</p>', 2, 1, '2013-09-14 20:09:54', 32),
(4, 4, '2013-09-14 00:00:00', 1, 'Я продал свою собаку. Потом я передумал. И потребовал ее назад. Деньги конечно вернул. Но случилась небольшая беда. Я не помню кому продал собаку и кому вернул деньги. Как мне быть?', '<p>Скорее всего вы сможете найти покупателя там, где он живет.</p>\r\n<p>Согласно исследованиям, проведенным британскими учеными в 1985 году, большинство людей можно найти по тому адресу, который они называют &quot;домом&quot;. Независимые эксперты также подтверждают эти выводы. Многие из них даже проверили данную теорию на себе.</p>\r\n<p>Успехов вам в поисках, пишите еще.</p>', 2, 1, '2013-09-14 00:00:00', 36),
(5, 5, '2013-09-14 00:00:00', 1, 'Скажите пожалуйста когда мне вернут экскаватор который я сдал на ремонт в июне 1937 года?', '<p>К сожалению, ответственному за это упущение сотруднику недавно исполнилось 94 года и мы не смогли добиться от него внятного ответа. Он утверждает что не помнит, мы конечно не верим и продолжим пытки, но на это потребуется время. Просим отнестись с пониманием.</p>', 2, 1, '2013-09-16 00:00:00', 36);
...
INSERT INTO `#__form_fields` (`id`, `form_id`, `title`, `description`, `ordering`, `kind`, `mustbe`, `config`) VALUES
(8, 1, 'Ваше имя:', '', 1, 'text', 1, '---\r\nmax: 200\r\nsize: 200\r\ndefault:\r\n'),
...
INSERT INTO `#__forum_cats` (`id`, `title`, `published`, `ordering`, `seolink`) VALUES
(1, 'Общие вопросы', 1, 1, 'obschie-voprosi');
...
INSERT INTO `#__forum_posts` (`id`, `thread_id`, `user_id`, `pubdate`, `editdate`, `edittimes`, `content`, `content_html`) VALUES
(29, 12, 1, '2013-09-04 18:54:53', '2013-09-07 18:07:14', 2, 'Геосинклиналь [b]обогащает магматический монтмориллонит[/b], что в общем свидетельствует о преобладании тектонических опусканий в это время. Углефикация характерна. Порода существенна. Тектогенез, разделенные узкими линейновытянутыми зонами выветрелых пород, \r\n\r\nпереоткладывает морской авгит, образуя на границе с Западно-Карельским поднятием своеобразную систему грабенов. Ведущий экзогенный геологический процесс - субдукция ослабляет лакколит, так как совершенно однозначно указывает на существование и рост в период оформления палеогеновой поверхности выравнивания.', 'Геосинклиналь <strong>обогащает магматический монтмориллонит</strong>, что в общем свидетельствует о преобладании тектонических опусканий в это время. Углефикация характерна. Порода существенна. Тектогенез, разделенные узкими линейновытянутыми зонами выветрелых пород, <br />переоткладывает морской авгит, образуя на границе с Западно-Карельским поднятием своеобразную систему грабенов. Ведущий экзогенный геологический процесс - субдукция ослабляет лакколит, так как совершенно однозначно указывает на существование и рост в период оформления палеогеновой поверхности выравнивания.');
...
INSERT INTO `#__forum_threads` (`id`, `forum_id`, `user_id`, `title`, `description`, `icon`, `pubdate`, `hits`, `closed`, `pinned`, `is_hidden`, `rel_to`, `rel_id`, `post_count`, `last_msg`) VALUES
(12, 1, 1, 'Пример темы', '', '', '2013-09-16 12:31:36', 71, 0, 0, 0, '', 0, 1, '---\npubdate: 2013-09-04 18:54:53\nid: 29\ncontent_html: ''Геосинклиналь <strong>обогащает магматический монтмориллонит</strong>, что в общем свидетельствует о преобладании тектонических опусканий в это время. Углефикация характерна. Порода существенна. Тектогенез, разделенные узкими линейновытянутыми зонами выветрелых пород, переоткладывает морской авгит, образуя на границе с Западно-Карельским поднятием своеобразную систему грабенов. Ведущий экзогенный геологический процесс - субдукция ослабляет лакколит, так как совершенно однозначно указывает на существование и рост в период оформления палеогеновой поверхности выравнивания.''\nauthor_nickname: Администратор\nauthor_login: admin\nthread_title: Пример темы\nthread_id: 12\npost_count: 1\nlastpage: 1\nthread_link: ''<a href="/forum/thread12-1.html#29">Пример темы</a>''\nuser_link: ''<a href="/users/admin" title="Администратор">Администратор</a>''\n');
...
(100, 0, 1, 1, 6, '', 0, 0, '-- Корневой альбом --', '', 1, 1, '', '2013-09-30 12:03:07', 'title', 'asc', 0, 15, '', 96, 480, 1, 'lightbox', 1, 0, 4, 1, 1, 1, 1, 0),
(1, 100, 6, 2, 3, '', 0, 1, 'Общий альбом', 'Любой зарегистрированный пользователь может добавить свою фотографию в этот альбом.', 1, 1, '', '2013-09-24 10:18:21', 'pubdate', 'asc', 2, 15, '', 96, 600, 1, 'lightbox', 1, 10, 5, 1, 1, 1, 1, 1),
(1034, 100, 8, 4, 5, '', 0, 1, 'Природа', 'Разные красивые пейзажи', 1, 1, '', '2013-09-12 13:44:56', 'pubdate', 'desc', 2, 20, '', 96, 600, 1, 'lightbox', 1, 20, 4, 1, 1, 1, 1, 1),
(1035, 0, 1, 1, 2, 'club14', 0, 0, 'Клуб: Клуб любителей InstantCMS', '', 0, 1, '', '2013-09-12 13:44:56', 'title', 'asc', 0, 15, '', 96, 480, 1, 'list', 1, 0, 4, 0, 1, 1, 14, 0);
...
(10, 1, 'Закат на пляже', '', '2013-09-31 18:26:43', 'd0633d5a84f03a27f1b7d0419947e968.jpg', 1, 25, 1, 1, 1, 'photos'),
(11, 1, 'Флорида', '', '2013-09-31 18:27:33', '5e7a09ffcaa383df24d25d56c315f0d0.jpg', 1, 28, 1, 1, 1, 'photos'),
(15, 1034, 'Красивый цветок', '', '2013-09-12 13:47:32', '312604de74e4de8aec59626ac024c7d3.jpg', 1, 6, 1, 1, 1, 'photos'),
(16, 1034, 'Густые джунгли', '', '2013-09-12 13:47:52', 'e223946b3d76cc37417d0304c9cb23a1.jpg', 1, 40, 1, 1, 1, 'photos'),
(17, 1034, 'Вид на озеро', '<p>Красивый темный пейзаж с видом на озеро</p>', '2013-09-12 17:00:27', '38fde6623d0ad43c79c4d90a88a07009.jpg', 1, 25, 1, 1, 1, 'photos');
...
(2, 'Какой у вас хостинг?', '2013-09-23', '---\nПлатный: 2\nБесплатный: 1\nСобственный: 0\n');
...
DROP TABLE IF EXISTS `#__tag_targets`;
CREATE TABLE `#__tag_targets` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `target` varchar(32) NOT NULL,
  `component` varchar(32) NOT NULL,
...
INSERT INTO `#__tag_targets` (`id`, `target`, `component`, `title`) VALUES
...
(1000, 0, '-- Корневая рубрика --', '', 1, '---\n', 'list', 10, 1, 20, 1, 1, 0, 'pubdate', 'desc', 1, 0, '', 0, 0, 1, 6, 0, 0, 0, 1, 0, 0, ''),
(2, 1000, 'Автомобили', '', 1, '---\n- Тип кузова/~m~/\n- Объем двигателя\n- Год выпуска/~m~/\n- Описание/~h~/\n', 'list', 2, 1, 20, 1, 1, 0, 'pubdate', 'desc', 1, 1, '2 DAY', 0, 0, 2, 3, 1, 0, 0, 22, 0, 0, ''),
(1, 1000, 'Канцелярские принадлежности', '', 1, '---\n- Артикул/~m~/\n- Цвета/~m~/\n- Минимальная партия\n- Описание/~h~/\n- Размер/~m~/\n- Скачать/~l~/\n', 'shop', 4, 0, 11, 0, 0, 0, 'hits', 'desc', 0, 0, '123 HOUR', 0, 0, 4, 5, 1, 0, 0, 23, 1, 0, '');
...
(1, 2, 'admin', 'Администратор', '', 'admin@cms.ru', '100200300', '2013-09-23 12:41:57', '2013-09-15 13:20:33', '1980-10-23', 0, 0, 0, 32, 0, '127.0.0.1', 'Самый длинный статус из всех что существуют в этом прекрасном мире', '2013-09-21 02:06:53', 0, '2013-09-09 23:25:59'),
(2, 1, 'vasya', 'Василий', '', 'vasya@cms.ru', '100200300', '2013-09-16 16:31:48', '2013-09-15 12:36:58', '1980-01-01', 0, 0, 0, 5, 0, '127.0.0.1', 'I love InstantCMS', '2013-09-13 23:09:34', 0, '2013-09-02 13:50:04'),
(3, 1, 'fedor', 'Федор', '', 'fedor@cms.com', '100334564', '2013-09-20 17:33:42', '2013-09-13 23:22:26', '1979-10-20', 0, 0, 0, 0, 0, '127.0.0.1', 'We are all made of stars (c) Moby', '2013-09-28 15:44:45', NULL, NULL);
...
(2, 3, 'Мой фотоальбом', '2013-09-22 20:28:51', 'all', ''),
(5, 1, 'Мои картинки', '2013-09-13 23:13:37', 'all', '');
...
(1, 2, '2013-09-27 21:46:44', 'Медаль за заслуги', 'В благодарность от администрации', 'aw.gif', 1, 0);
...
(1, 2, 1, '2013-09-08 17:53:22', 1),
(2, 3, 2, '2013-09-21 01:22:27', 1),
(11, 3, 1, '2013-09-13 23:18:19', 1);
...
DROP TABLE IF EXISTS `#__user_groups_access`;
CREATE TABLE IF NOT EXISTS `#__user_groups_access` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
...
(6, 1, 5, '2013-09-13 00:00:00', 'Горный пейзаж', 'Красивый вид с большой высоты', 'all', 4, 'b22c5c0f95c1fb9398578fd5e396c7dd.jpg'),
(7, 1, 5, '2013-09-13 00:00:00', 'Восход в космосе', 'Вид на нашу планету', 'all', 3, 'efe8d13779cd84cfeb319d9f0875a511.jpg');
...
(2, 2, 'Воронеж', 'живопись, музыка, PHP', 0, 0, 1, 0, '', 'all', '', 'm', '---\n22: |\n  POD, Fuze, Каста\n24: Высшее\n', 1, '0', ''),
(3, 3, 'Екатеринбург', '', 0, 0, 1, 0, '', 'all', '', '', '', 1, '', '');
...
(6, 1, 1, '2013-09-22 20:52:56', 'Спасибо, что заглянули в мой профиль', 'users'),
(7, 3, 2, '2013-09-28 16:12:16', 'Так рад тебя здесь видеть!', 'users'),
(9, 2, 1, '2013-09-09 17:24:05', 'InstantCMS + Биллинг + InstantMaps + InstantVideo + InstantShop = СИЛА :-)', 'users');

DROP TABLE IF EXISTS `#__geo_cities`;
CREATE TABLE `#__geo_cities` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
...
INSERT INTO `#__geo_cities` (`id`, `country_id`, `region_id`, `name`) VALUES
...
DROP TABLE IF EXISTS `#__geo_countries`;
CREATE TABLE `#__geo_countries` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `name` varchar(128) NOT NULL DEFAULT '',
...
INSERT INTO `#__geo_countries` (`id`, `name`, `alpha2`, `alpha3`, `iso`, `ordering`) VALUES
...
DROP TABLE IF EXISTS `#__geo_regions`;
CREATE TABLE `#__geo_regions` (
...
INSERT INTO `#__geo_regions` (`id`, `country_id`, `name`) VALUES
