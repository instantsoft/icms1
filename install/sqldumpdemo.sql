...
(2, 11, '2016-06-13 23:09:34', 2, '', '', 0, '', '', 0, 'I love InstantCMS', 0, 0),
(3, 2, '2016-06-13 23:11:00', 2, 'комментарий', '/stati/marketing/yelastichnost-sprosa.html#c13', 13, 'Эластичность спроса', '/stati/marketing/yelastichnost-sprosa.html', 0, 'Спасибо автору за такую отличную статью!', 0, 0),
(4, 27, '2016-06-13 23:13:37', 1, '2', '', 0, 'Мои картинки', '/users/admin/photos/private5.html', 5, ' <a href="/users/1/photo6.html" class="act_photo">\r\n											<img border="0" src="/images/users/photos/small/b22c5c0f95c1fb9398578fd5e396c7dd.jpg" />\r\n									</a>  <a href="/users/1/photo7.html" class="act_photo">\r\n											<img border="0" src="/images/users/photos/small/efe8d13779cd84cfeb319d9f0875a511.jpg" />\r\n									</a> ', 0, 0),
(5, 20, '2016-06-13 23:18:39', 3, 'Администратор', '/users/admin', 11, '', '', 0, '', 0, 0),
(6, 2, '2016-06-13 23:19:19', 3, 'комментарий', '/stati/marketing/yelastichnost-sprosa.html#c14', 14, 'Эластичность спроса', '/stati/marketing/yelastichnost-sprosa.html', 0, 'Полностью согласен с Вами, коллега.', 0, 0),
(7, 15, '2016-06-13 23:21:43', 3, 'Клуб любителей InstantCMS', '/clubs/14', 14, '', '', 0, '', 0, 0);
...
(1, 1, 'Пример блога админа', '2016-06-03 13:26:55', 'all', 'list', 1, 'single', 0, 1, 'user', 'primer-bloga-admina', 0),
(24, 14, 'Блог клуба любителей InstantCMS', '2016-06-20 00:02:41', 'all', 'list', 1, 'multi', 0, 0, 'club', 'instantcms-lovers', 0);
...
(14, 1, 'Клуб любителей InstantCMS', '', '', '2016-06-12 14:41:45', 'public', 1, 0, '-1', '-1', 0, 2, 0, 0, 0, 0, 25, 0, 0, 0, 0, 0);
...
(8, 0, 0, 1, 'article', 32, '', 'Питание прогиба исходным материалом, несмотря на не менее значительную разницу в плотности теплового потока, составляет биотит, так как совершенно однозначно указывает на существование', '', '2016-06-13 23:45:56', 1, 1, 'Почему нерезко плато?!!!', '/content/stati/geologija/pochemu-nerezko-plato.html', ''),
(13, 0, 0, 2, 'article', 34, '', 'Спасибо автору за такую отличную статью!', '', '2016-06-13 23:11:00', 1, 1, 'Эластичность спроса', '/stati/marketing/yelastichnost-sprosa.html', '127.0.0.1'),
(14, 13, 0, 3, 'article', 34, '', 'Полностью согласен с Вами, коллега.', '', '2016-06-13 23:19:19', 1, 1, 'Эластичность спроса', '/stati/marketing/yelastichnost-sprosa.html', '127.0.0.1');
...
(1, 'photos_clear', 24, '2016-06-07 12:10:08', 'users', 'clearUploadedPhotos', '', 1, 1, 'Удаление неиспользуемых личных фотографий', '', ''),
(2, 'optimize_tables', 24, '2016-06-07 12:10:08', '', '', '', 1, 1, 'Оптимизация таблиц БД', 'db|cmsDatabase', 'optimizeTables'),
(3, 'drop_inactive_users', 48, '2016-06-07 12:10:08', 'users', 'deleteInactiveUsers', '', 1, 1, 'Удаление неактивных пользователей (см. настройки компонента "Профили пользователей")', '', ''),
(4, 'remove_old_log', 48, '2016-06-07 12:10:08', '', '', '', 1, 1, 'Удаляет старые записи ленты событий', 'actions|cmsActions', 'removeOldLog'),
(5, 'give_invites', 24, '2016-06-07 12:10:08', 'users', 'giveInvitesCron', '', 1, 1, 'Выдача инвайтов пользователям', '', ''),
(6, 'clear_invites', 24, '2016-06-07 12:10:08', 'users', 'clearInvites', '', 1, 1, 'Удаление использованных инвайтов', '', ''),
(7, 'deleteOldResults', 24, '2016-06-07 12:10:08', 'search', 'deleteOldResults', '', 1, 1, 'Удаляет записи в кеше поиска старее 1 дня.', '', ''),
(8, 'deleteOldNotification', 48, '2016-06-31 23:19:42', 'users', 'deleteOldNotification', '', 1, 1, 'Удаляет сообщения службы обновлений и рассылки старее 1 месяца', '', ''),
(9, 'moveArticlesToArchive', 24, '2016-06-29 18:25:10', 'content', 'moveArticlesToArchive', '', 1, 0, 'Переносит просроченные статьи в архив', '', ''),
(10, 'clearOnlineUsers', 0, '2016-06-21 17:30:01', '', '', '', 1, 0, 'Удаляет просроченные данные об online пользователях', 'user|cmsUser', 'clearOnlineUsers');
...
(12, 1, 1, 'Пример темы', '', '', '2016-06-16 12:31:36', 71, 0, 0, 0, '', 0, 1, '---\npubdate: 2016-06-04 18:54:53\nid: 29\ncontent_html: ''Геосинклиналь <strong>обогащает магматический монтмориллонит</strong>, что в общем свидетельствует о преобладании тектонических опусканий в это время. Углефикация характерна. Порода существенна. Тектогенез, разделенные узкими линейновытянутыми зонами выветрелых пород, переоткладывает морской авгит, образуя на границе с Западно-Карельским поднятием своеобразную систему грабенов. Ведущий экзогенный геологический процесс - субдукция ослабляет лакколит, так как совершенно однозначно указывает на существование и рост в период оформления палеогеновой поверхности выравнивания.''\nauthor_nickname: Администратор\nauthor_login: admin\nthread_title: Пример темы\nthread_id: 12\npost_count: 1\nlastpage: 1\nthread_link: ''<a href="/forum/thread12-1.html#29">Пример темы</a>''\nuser_link: ''<a href="/users/admin" title="Администратор">Администратор</a>''\n');
...
(100, 0, 1, 1, 6, '', 0, 0, '-- Корневой альбом --', '', 1, 1, '', '2016-06-30 12:03:07', 'title', 'asc', 0, 15, '', 96, 480, 1, 'lightbox', 1, 0, 4, 1, 1, 1, 1, 0),
(1, 100, 6, 2, 3, '', 0, 1, 'Общий альбом', 'Любой зарегистрированный пользователь может добавить свою фотографию в этот альбом.', 1, 1, '', '2016-06-24 10:18:21', 'pubdate', 'asc', 2, 15, '', 96, 600, 1, 'lightbox', 1, 10, 5, 1, 1, 1, 1, 1),
(1034, 100, 8, 4, 5, '', 0, 1, 'Природа', 'Разные красивые пейзажи', 1, 1, '', '2016-06-12 13:44:56', 'pubdate', 'desc', 2, 20, '', 96, 600, 1, 'lightbox', 1, 20, 4, 1, 1, 1, 1, 1),
(1035, 0, 1, 1, 2, 'club14', 0, 0, 'Клуб: Клуб любителей InstantCMS', '', 0, 1, '', '2016-06-12 13:44:56', 'title', 'asc', 0, 15, '', 96, 480, 1, 'list', 1, 0, 4, 0, 1, 1, 14, 0);
...
(1, 2, 'admin', 'Администратор', '', 'admin@cms.ru', '100200300', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, '1980-10-23', 0, 0, 0, 32, 0, '127.0.0.1', 'Самый длинный статус из всех что существуют в этом прекрасном мире', CURRENT_TIMESTAMP, 0, CURRENT_TIMESTAMP),
(2, 1, 'vasya', 'Василий', '', 'vasya@cms.ru', '100200300', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, '1980-01-01', 0, 0, 0, 5, 0, '127.0.0.1', 'I love InstantCMS', CURRENT_TIMESTAMP, 0, CURRENT_TIMESTAMP),
(3, 1, 'fedor', 'Федор', '', 'fedor@cms.com', '100334564', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, '1979-10-20', 0, 0, 0, 0, 0, '127.0.0.1', 'We are all made of stars (c) Moby', CURRENT_TIMESTAMP, NULL, NULL);
...
(2, 3, 'Мой фотоальбом', '2016-06-22 20:28:51', 'all', ''),
(5, 1, 'Мои картинки', '2016-06-13 23:13:37', 'all', '');
...
(1, 2, CURRENT_TIMESTAMP, 'Медаль за заслуги', 'В благодарность от администрации', 'aw.gif', 1, 0);
...
(1, 2, 1, '2016-06-08 17:53:22', 1),
(2, 3, 2, '2016-06-21 01:22:27', 1),
(11, 3, 1, '2016-06-13 23:18:19', 1);
...
(6, 1, 5, '2016-06-13 00:00:00', 'Горный пейзаж', 'Красивый вид с большой высоты', 'all', 4, 'b22c5c0f95c1fb9398578fd5e396c7dd.jpg'),
(7, 1, 5, '2016-06-13 00:00:00', 'Восход в космосе', 'Вид на нашу планету', 'all', 3, 'efe8d13779cd84cfeb319d9f0875a511.jpg');
...
(6, 1, 1, NOW(), 'Спасибо, что заглянули в мой профиль', 'users'),
(7, 3, 2, NOW(), 'Так рад тебя здесь видеть!', 'users'),
(9, 2, 1, NOW(), 'InstantCMS + Биллинг + InstantMaps + InstantVideo + InstantShop = СИЛА :-)', 'users');
