<table align="left" cellpadding="2" cellspacing="0">
    <tr>
        ...
        <td valign="middle">
            ...
            <div><a href="#" onclick="return reloadCaptcha ();"><small>{$LANG.P_CAPTCHA_RELOAD}</small></a></div>
...
<script type="text/javascript">
    function reloadCaptcha (){
        $('#kcaptcha{$input_id}').attr('src', '/plugins/p_kcaptcha/codegen/cms_codegen.php?'+Math.random()+'&id={$input_id}');
        return false;
    }
</script>