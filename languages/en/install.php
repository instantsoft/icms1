...
$_LANG['INS_CHECK_PHP_TITLE']            = 'Testing PHP';
$_LANG['INS_CHECK_PHP']                  = 'Testing PHP extended';
$_LANG['INS_CHECK_FOLDER_TITLE']         = 'Testing rights';
$_LANG['INS_CHECK_FOLDER']               = 'Testing folders pemission';
...
$_LANG['INS_CRON_TODO']                  = 'Create a to do list for CRON';
$_LANG['INS_CRON_NOTES']                 = 'Add file <strong>/cron.php</strong> in CRON task schedule in the panel of your hosting.<br/> The interval is &mdash; 24 hours. This will allow the system to perform periodic service tasks. Possible command added to the CRON, looks like: ';
$_LANG['INS_FEEDBACK_SUPPORT']           = 'If you have doubts, contact the web hosting technical support.';
$_LANG['INS_ATTENTION']                  = 'Attention!';
$_LANG['INS_DELETE_TODO']                = 'Before transition to the site you should delete the directories "install" and "migrate"<br/> at the server with all included files!';
$_LANG['INS_GO_SITE']                    = 'Transition to the site';
$_LANG['INS_GO_CP']                      = 'Control Panel';
$_LANG['INS_GO_HANDBOOK']                = 'Handbook for beginners';
$_LANG['INS_GO_VIDEO']                   = 'Video lessons';
$_LANG['INS_NEXT']                       = 'Next →';
$_LANG['INS_BACK']                       = '← Back';
